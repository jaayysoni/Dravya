...
class Pledge(Base):
    ...
    donor_id        = Column(Integer, ForeignKey("donors.donor_id"), nullable=True)  # NULL = unassigned role
    ...
    # in-kind
    item_name    = Column(String,          nullable=True)   # also used as role_name for ROLE pledges
